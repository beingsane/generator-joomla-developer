...
class JConfig {
	...
	public $ftp_root = '';
	public $ftp_enable = '';
	public $tmp_path = '<%= path %>\\<%= repositoryName %>/tmp';                // Please check with your host that this is the correct path to the temp directory. This path needs to be writable by Joomla!
	public $log_path = '<%= path %>\\<%= repositoryName %>/logs';           // Please check with your host that this is the correct path to the logs directory. This path needs to be writable by Joomla!
