...
class <%= camelcase %>Model<%= editcamelcase %> extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		{
			// Disable fields for display.<% if (db.fields.ordering) { %>
			$form->setFieldAttribute('ordering', 'disabled', 'true');<% } %>
			$form->setFieldAttribute('state', 'disabled', 'true');<% if (db.fields.publish) { %>
			$form->setFieldAttribute('publish_up', 'disabled', 'true');
			$form->setFieldAttribute('publish_down', 'disabled', 'true');<% } %>

			// Disable fields while saving.
			// The controller has already verified this is a record you can edit.<% if (db.fields.ordering) { %>
			$form->setFieldAttribute('ordering', 'filter', 'unset');<% } %>
			$form->setFieldAttribute('state', 'filter', 'unset');<% if (db.fields.publish) { %>
	...
	public function getItem($pk = null)
	{
		...
		{
			// Convert the metadata field to an array.<% if (db.fields.metadata) { %>
	...
	protected function prepareTable($table)
	{
		...
		$table->title = htmlspecialchars_decode($table->title, ENT_QUOTES);<% if (db.fields.alias) { %>
		...
		{
			// Set the values
			<% if (db.fields.ordering || db.fields.timestamp) { %>
		...
		<% if (db.fields.version) { %>
		// Increment the <%= editview %> version number.
		$table->version++;<% } %>
	}
	<% if (db.fields.categories && db.fields.ordering) { %>
	/**
