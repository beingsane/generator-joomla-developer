...
class <%= camelcase %>Table<%= editviewcamelcase %> extends JTable
{
	...
	{<% if (db.fields.timestamps) { %>
		...
		{
			$this->setError(JText::_('COM_<% language %>_ERROR_UNIQUE_ALIAS'));
			return false;
		}<% } %>
		<% if (db.fields.url) { %>
	...
	{<% if (db.fields.url) { %>
		...
		{
			$this->setError(JText::_('COM_<% language %>_ERR_TABLES_PROVIDE_URL'));
			return false;
		}
		...
		if (trim($this->title) == '')
		{
			$this->setError(JText::_('COM_<% language %>_ERR_TABLES_TITLE'));
			return false;
		}
		...
		{
			$this->setError(JText::_('COM_<% language %>_ERR_TABLES_NAME'));
			return false;
		}
		<% if (db.fields.alias) {  %>
		if (empty($this->alias))
