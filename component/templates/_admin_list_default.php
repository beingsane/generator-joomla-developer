			...
			<table class="table table-striped" id="weblinkList">
				<thead>
					<tr>
						...
						</th><% if (db.fields.hits) { %>
						<th width="5%" class="nowrap center hidden-phone">
							<?php echo JHtml::_('grid.sort', 'JGLOBAL_HITS', 'a.hits', $listDirn, $listOrder); ?>
						</th><% } %><% if (db.fields.language) { %>
						<th width="5%" class="nowrap hidden-phone">
				...
				<tfoot>
					<tr><% var count = 7; if (db.fields.publish) count++; if (db.fields.language) count++; if (db.fields.hits) count++; %>
						<td colspan="<%= count %>">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
						...
						</td><% if (db.fields.hits) { %>
						<td class="center hidden-phone">
							<?php echo $item->hits; ?>
						</td><% } %><% if (db.fields.language) { %>
